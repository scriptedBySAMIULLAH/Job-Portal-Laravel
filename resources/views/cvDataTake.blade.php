...
<body class="bg-[#d3d2cf]">
    ...
    <form action="{{route('cv_validator',['dataTakeForm'])}}" class="px-4 space-y-6" method="post" enctype="multipart/form-data" id="cvForm">
        @csrf
        <!-- Step 1 -->
        <div id="step-1">
            <p class="text-4xl text-red-950">Resume Heading</p>
            <strong class="heading">Basic Bio</strong>

            <div class="flex justify-between items-center">
                <button type="button" id="customButton" onclick="opn()" class="btn3">
                    Choose Image
                </button>
                @error('img')
                <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                @enderror
                <small class="text-gray-700">Please upload less than 5MB</small>
                <div>
                    <input type="file" name="img" id="img" accept="image/*" onchange="uploadImage(event)" class="hidden" />
                </div>

                <div class="hidden float-right" id="img-holder">
            ...
            <div class=" space-y-4">
                <div class="flex gap-4">
                    <div>
                        ...
                        <input type="text" id="name" name="name" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" maxlength="25" placeholder="John" required />
                        @error('name')
                        <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="text" id="surname" name="surname" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" placeholder="Doe" required />
                        @error('surname')
                        <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <input type="text" id="profession" name="profession" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 w-18 px-3 placeholder-gray-700" placeholder="Web developer" required />
                    @error('profession')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                ...
                <div>
                    <label for="experience-level" class="block text-gray-700  ">Experience-level</label>
                    <select name="experience_level" id="experience-level" class="inpt">
                        <option value="experience_level" disabled selected>Experience_level</option>
                    ...
                    @error('experience-level')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <div class="mt-4 space-y-2">
                    <label for="LinkedIn Profile" class="block text-gray-700">LinkedIn Profile</label>
                    <input type="text" placeholder="LinkedIn Profile" name="linkedinprofile" class="inpt" id="LinkedIn Profile">
                    @error('linkedinprofile')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                    <label for="Website/Portfolio" class="block text-gray-700">Website/Portfolio</label>

                    <input type="text" placeholder="Website/Portfolio" name="websiteportfolio" class="inpt" id="Website/Portfolio">
                    @error('websiteportfolio')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <div>
                    <label for="city-state" class="block text-gray-700">City-state</label>
                    <input type="text" name="city_state" id="city-state" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" placeholder="Islamabad" maxlength="20" required />
                    @error('city_state')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 w-60 placeholder-gray-700" placeholder="+92 3115...." min="0" required />
                    @error('phone')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="email" name="email" id="email" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" placeholder="johndoe@gmail.com" required />
                    @error('email')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <div class="mb-4">
                    <label for="yourself" class="block text-gray-700">Littel About Yourself</label>
                    <textarea name="yourself" id="yourself" cols="30" rows="8" class="inpt placeholder-gray-700" maxlength="50" placeholder="I'm a web developer and build websites....."></textarea>
                    @error('yourself')
                    <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                    @enderror
                </div>
                <button type="button" onclick="Next(2,'step-1')" class="btn3" id="stp1">Next</button>
            </div>
        </div>
        ...
        <div class=" hidden flex-col px-4" id="step-3">
            <strong class="text-center font-montserrat">Work History</strong>
                ...
                <div id="main-wrapper">
                    <div class="flex gap-4">
                        <div>
                            ...
                            <input type="text" name="JobTitle[]" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" placeholder="UI designer" maxlength="100" required />
                            @error('JobTitle')
                            <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="Employer" required
                                class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700"
                                maxlength="100" name="Employer[]" placeholder="MicroSoft Coperation" />
                            @error('Employer')
                            <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="Location" name="Location[]" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-gray-700" placeholder="Rawalpindi" maxlength="50" required />
                            @error('Location')
                            <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                            @enderror
                        </div>
            ...
            <button type="button" onclick="addmore(3)" class="border  border-blue-700 text-blue-700 focus:ring-2 bg-transparent px-1 py-0   text-lg font-bold hover:bg-slate-200"><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
                    <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" />
                </svg></button>
            <br>
        ...
        <div class="hidden" id="step-4">
                ...
                <div id="mainwrpr" class="space-y-6">
                    <div class="flex gap-4">
                        <div>
                            ...
                            <input type="text" id="schName" name="schName[]" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3" placeholder="egUniversity of Karachi" required maxlength="100" />
                            @error('schName')
                            <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" id="schlLoc" name="schlLoc[]" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3" placeholder="eg.Islamabad" required maxlength="100" />
                            @error('schlLoc')
                            <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                            @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="filtudy" name="fieldstudy[]" class="rounded-sm border border-gray-500 bg-transparent text-black hover:ring-2 outline-none ring-gray-600 px-3 placeholder-slate-500" placeholder="eg.Computer science" required maxlength="20" />
                        @error('fieldstudy')
                        <span class="text-red-700 font-bold font-montserrat">{{($message)}}</span>
                        @enderror
                    </div>
            ...
            <button onclick="addmore(4)" class="border mt-2 border-blue-700 text-blue-700 focus:ring-2 bg-transparent px-1 py-0   text-lg font-bold hover:bg-slate-200"><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
                    <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" />
                </svg></button>
            <br>
        ...
        <div class="hidden space-y-5" id="step-5">
            ...
            <button onclick="addmore(5)" class="border mt-2 border-blue-700 text-blue-700 focus:ring-2 bg-transparent px-1 py-0   text-lg font-bold hover:bg-slate-200"><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
                    <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" />
                </svg></button>
            <button type="button" onclick="Previous(4,'step-5')" class="btn3">Previous</button>
            @if (Auth::check())
            <button type="submit" class="btn3 hover:bg-gradient-to-tr from-orange-300 to-pink-300 ">submit</button>
            @endif
            @if (!Auth::check())
            <button onclick="chkLogin()" type="button" class="btn3 hover:bg-gradient-to-tr from-orange-300 to-pink-300 ">Submit</button>
            @endif
        </div>
...
<script>
    function chkLogin() {
        ...
        Swal.fire('Login to proceed further')
...
<script>
  ...
  <select name="rate[]" 
    ...
    <option value="5" class="bg-gray-300">⭐⭐⭐⭐⭐</option>
           ...
           <div  id="project_box">
              ...
              <div class=" border border-b-4 border-b-black h-8"></div>
                 <button id="delete" class="border w-fit mt-4 border-black bg-transparent text-black px-2 focus:ring-2 focus:ring-red-700" onClick=del(this)><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#8B0000"><path d="m291-240-51-51 189-189-189-189 51-51 189 189 189-189 51 51-189 189 189 189-51 51-189-189-189 189Z"/></svg></button>
                <label for="techUse " class="block text-gray-700 ">Technologies Used</label>
                <input type="text" name="techUse[]" id="techUse" class="inpt w-3/6">
                <label for="projects" class="block   text-gray-700">Project Description</label>
                <textarea name="projects[]" id="projects" cols="8" rows="4" placeholder="Briefly describe the project and your responsibilities." class="placeholder-gray-700 inpt border  bg-gray-400 p-2 focus:outline-none w-3/6"></textarea>
    ...
    function uploadImage(event) {
        ...
        let file = event.target.files[0]; //get the file which is uploaded by usr
        console.log(file);
...
<!-- this is customization imported from internet for editior -->
<script>
    CKEDITOR.replace('skil', {
...
<!-- this is customization imported from internet for editior ens-->
